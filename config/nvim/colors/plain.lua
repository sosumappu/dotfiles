...
highlight("IncSearch", { bg = colors.selection, fg = colors.selection_fg, bold = true })
...
-- __WildMenu__
highlight("WildMenu", { underline = true, bold = true, bg = colors.bg, fg = colors.norm })

highlight("StatusLineOk", { underline = true, bg = colors.bg, fg = colors.ok })
highlight("StatusLineError", { underline = true, bg = colors.bg, fg = colors.error })
highlight("StatusLineWarning", { underline = true, bg = colors.bg, fg = colors.warning })
...
highlight("MutedImportsInfo", { italic = true, bold = true, bg = nil, fg = colors.bg_subtle })
...
highlight("OverLength", { fg = nil, bg = colors.selection_fg, ctermbg = 234, ctermfg = nil })
