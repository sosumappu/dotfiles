            ...
            claude_code = function()
              return require("codecompanion.adapters").extend("claude_code", {
                ...
                env = {
                  ...
                  CLAUDE_CODE_OAUTH_TOKEN = os.getenv("CC_ANTHROPIC_API_KEY"),
                },
              })
            end,
            gemini_cli = function()
              return require("codecompanion.adapters").extend("gemini_cli", {
                ...
                defaults = {
                  auth_method = not utils.is_localhost() and "oauth-personal" or "gemini-api-key",
                },
              })
            end,
          },
          ...
          chat = {
            ...
            roles = {
              llm = function(adp)
                ...
                return string.format(" %s %s (%s)", icon .. " ", adp.name, adp.type == "acp" and adp.formatted_name or adp.model.name)
              end,
              user = vim.env.USER,
            },
          },
