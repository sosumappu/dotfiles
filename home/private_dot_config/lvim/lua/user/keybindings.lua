...
M.markdown_heading_fold = function()
  local whk_status, whk = pcall(require, "which-key")
  if not whk_status then
    return
  end
  whk.register({
    ["z"] = {
      u = {
        ...
        "[P]Unfold all headings level 2 or above",
      },
      j = {
        function()
          vim.cmd("edit!")
        ...
        "[P]Fold all headings level 1 or above",
      },
      k = {
        function()
          vim.cmd("edit!")
        ...
        "[P]Fold all headings level 2 or above",
      },
      l = {
        function()
          vim.cmd("edit!")
        ...
        "[P]Fold all headings level 3 or above",
      },
      [";"] = {
        function()
          vim.cmd("edit!")
        ...
        "[P]Fold all headings level 4 or above",
      },
    },
  })
end
