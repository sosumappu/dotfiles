let
  module = let
    firefoxHomeModule = {
      ...
      firefoxChromeDir = ../../../../config/firefox/chrome;
    in {
      programs.firefox = {
        enable = false;
        package =
        ...
        profiles = {
          "${config.home.username}" = {
            ...
            userChrome = builtins.readFile (firefoxChromeDir + "/userChrome.css");
            userContent = builtins.readFile (firefoxChromeDir + "/userContent.css");
            ...
            settings = {
              ...
              "identity.fxaccounts.account.device.name" = myConfig.hostName;
